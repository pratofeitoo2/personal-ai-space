---
title: Plotting Task Completions with DataviewJS and Obsidian Charts
source: https://obsidian.rocks/plotting-task-completions-with-dataviewjs-and-obsidian-charts/
author:
  - "[[Tim Miller]]"
published: 2023-07-28
created: 2025-12-07
description: Interested in plotting in Obsidian? Graphing in Obsidian is fun, and not always difficult. Here's an easy way to plot tasks in Obsidian.
tags:
  - clippings
---
Have you tried [plotting in Obsidian](https://obsidian.rocks/creating-dynamic-graphs-in-obsidian/)?
