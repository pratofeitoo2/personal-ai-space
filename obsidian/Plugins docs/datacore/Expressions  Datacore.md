---
title: Expressions | Datacore
source: https://blacksmithgu.github.io/datacore/expressions
author:
published:
created: 2025-12-07
description: Datacore has an internal "expression language", which can be used essentially as a simple scripting language in various parts of Datacore. The most common use cases is in queries, for filtering down to a desired set of pages, though they can also be used via the Javascript View API
tags:
  - clippings
---
...
Datacore expressions vaguely resemble Javascript, with some special syntax considerations for dates, durations, and links. A reference table of all of the available operations is [below](https://blacksmithgu.github.io/datacore/#syntax-reference).
