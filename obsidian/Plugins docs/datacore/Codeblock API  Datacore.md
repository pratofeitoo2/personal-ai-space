---
title: Codeblock API | Datacore
source: https://blacksmithgu.github.io/datacore/code-views/local-api
author:
published:
created: 2025-12-07
description: Datacore views are built around the datacore codeblock (also known as "local") API, which is available in any datacore
tags:
  - clippings
---
