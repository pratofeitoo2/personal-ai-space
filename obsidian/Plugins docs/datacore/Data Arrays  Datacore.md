---
title: Data Arrays | Datacore
source: https://blacksmithgu.github.io/datacore/code-views/data-array
author:
published:
created: 2025-12-07
description: To make common data manipulation operations simple, datacore provides the DataArray abstraction, which is a proxied wrapper around a regular list with a large set of additional functions.
tags:
  - clippings
---
