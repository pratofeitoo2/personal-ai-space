---
title: Functions | Datacore
source: https://blacksmithgu.github.io/datacore/expressions/functions
author:
published:
created: 2025-12-07
description: Datacore comes with a default set of functions, which can be used in expressions for various purposes.
tags:
  - clippings
---
...
Datacore functions support "vectorization", meaning you can also replace any argument with a *list* of arguments instead; the function will return a list of results instead of a single value:
...
- For strings, it behaves exactly like [`contains()`](https://blacksmithgu.github.io/datacore/expressions/#containsobjectliststring-value).
	```js
