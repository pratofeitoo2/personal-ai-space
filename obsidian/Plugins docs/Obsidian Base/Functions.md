...
---
Functions are used in [Bases](https://help.obsidian.md/bases) to manipulate data from [properties](https://help.obsidian.md/properties) in [filters](https://help.obsidian.md/bases/views#Filters) and [formulas](https://help.obsidian.md/formulas). See the [bases syntax](https://help.obsidian.md/bases/syntax) reference to learn more about how you can use functions.
...
- Example: `file.hasTag("tag1", "tag2")` returns `true` if the file has tag `#tag1` or `#tag2`. It also includes any [nested tags](https://help.obsidian.md/tags#Nested%20tags), such as `#tag1/a` or `#tag2/b`.
