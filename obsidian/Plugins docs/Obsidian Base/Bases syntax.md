...
The [Bases](https://help.obsidian.md/bases) syntax defines [Views](https://help.obsidian.md/bases/views), filters, and [formulas](https://help.obsidian.md/formulas). Bases must be valid YAML conforming to the schema defined below.
...
The `formulas` section defines [formula properties](https://help.obsidian.md/formulas) that can be displayed across all views in the base file.
