...
|------|-------------------|
| General documentation | [Documentation Database](ai/GenAi/LLMs/AI%20Agents/Skills/awesome-llm-skills/notion-knowledge-capture/reference/documentation-database.md) |
| Track decisions | [Decision Log](ai/GenAi/LLMs/AI%20Agents/Skills/awesome-llm-skills/notion-knowledge-capture/reference/decision-log-database.md) |
| Q&A knowledge base | [FAQ Database](ai/GenAi/LLMs/AI%20Agents/Skills/awesome-llm-skills/notion-knowledge-capture/reference/faq-database.md) |
| Team-specific content | [Team Wiki](ai/GenAi/LLMs/AI%20Agents/Skills/awesome-llm-skills/notion-knowledge-capture/reference/team-wiki-database.md) |
| Step-by-step guides | [How-To Guide Database](ai/GenAi/LLMs/AI%20Agents/Skills/awesome-llm-skills/notion-knowledge-capture/reference/how-to-guide-database.md) |
| Incident/project learnings | [Learning Database](ai/GenAi/LLMs/AI%20Agents/Skills/awesome-llm-skills/notion-knowledge-capture/reference/learning-database.md) |
