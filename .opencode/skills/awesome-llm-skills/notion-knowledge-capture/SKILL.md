...
See [reference/database-best-practices.md](ai/GenAi/LLMs/AI%20Agents/Skills/awesome-llm-skills/notion-knowledge-capture/reference/database-best-practices.md) for database selection guide and individual schema files.
...
**Documentation databases**: See [reference/database-best-practices.md](ai/GenAi/LLMs/AI%20Agents/Skills/awesome-llm-skills/notion-knowledge-capture/reference/database-best-practices.md) for database schema patterns.
...
- [examples/conversation-to-faq.md](ai/GenAi/LLMs/AI%20Agents/Skills/awesome-llm-skills/notion-knowledge-capture/examples/conversation-to-faq.md) - FAQ from Q&A
- [examples/decision-capture.md](ai/GenAi/LLMs/AI%20Agents/Skills/awesome-llm-skills/notion-knowledge-capture/examples/decision-capture.md) - Decision record
- [examples/how-to-guide.md](ai/GenAi/LLMs/AI%20Agents/Skills/awesome-llm-skills/notion-knowledge-capture/examples/how-to-guide.md) - How-to from discussion
