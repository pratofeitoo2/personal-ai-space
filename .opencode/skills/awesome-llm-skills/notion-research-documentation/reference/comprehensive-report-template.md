...
Use for in-depth research requiring extensive analysis. See [comprehensive-report-format.md](ai/GenAi/LLMs/AI%20Agents/Skills/awesome-llm-skills/notion-research-documentation/reference/comprehensive-report-format.md) for when to use this format.
