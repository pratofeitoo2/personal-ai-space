...
Use when researching multiple options or alternatives. See [comparison-format.md](ai/GenAi/LLMs/AI%20Agents/Skills/awesome-llm-skills/notion-research-documentation/reference/comparison-format.md) for when to use this format.
