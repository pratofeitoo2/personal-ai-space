...
See [reference/template-selection-guide.md](ai/GenAi/LLMs/AI%20Agents/Skills/awesome-llm-skills/notion-meeting-intelligence/reference/template-selection-guide.md) for full templates.
...
See [reference/template-selection-guide.md](ai/GenAi/LLMs/AI%20Agents/Skills/awesome-llm-skills/notion-meeting-intelligence/reference/template-selection-guide.md) for complete templates.
...
**Meeting templates**: See [reference/template-selection-guide.md](ai/GenAi/LLMs/AI%20Agents/Skills/awesome-llm-skills/notion-meeting-intelligence/reference/template-selection-guide.md) for comprehensive template library
...
- [examples/project-decision.md](ai/GenAi/LLMs/AI%20Agents/Skills/awesome-llm-skills/notion-meeting-intelligence/examples/project-decision.md) - Decision meeting prep with pre-read
- [examples/sprint-planning.md](ai/GenAi/LLMs/AI%20Agents/Skills/awesome-llm-skills/notion-meeting-intelligence/examples/sprint-planning.md) - Sprint planning meeting
- [examples/executive-review.md](ai/GenAi/LLMs/AI%20Agents/Skills/awesome-llm-skills/notion-meeting-intelligence/examples/executive-review.md) - Executive review prep
- [examples/customer-meeting.md](ai/GenAi/LLMs/AI%20Agents/Skills/awesome-llm-skills/notion-meeting-intelligence/examples/customer-meeting.md) - External meeting with customer (pre-read + agenda)
