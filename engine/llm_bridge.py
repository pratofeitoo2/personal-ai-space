...
INTENT_CATALOGUE: list[IntentDef] = [
    ...
    # GitHub Agent
    IntentDef("github-agent", "status",
              "Show git status for a repository",
              ["git status", "show status", "what's the status", "show me changes",
               "what's modified", "uncommitted changes", "repo status"]),
    IntentDef("github-agent", "clone",
              "Clone a git repository",
              ["clone repo", "clone repository", "clone from github", "download repo",
               "git clone", "get repo", "fetch repo"]),
    IntentDef("github-agent", "init",
              "Initialize a new git repository",
              ["init repo", "initialize git", "git init", "start a repo", "create new repo"]),
    IntentDef("github-agent", "branch_list",
              "List branches in a repository",
              ["show branches", "list branches", "what branches", "git branches",
               "all branches", "branch list"]),
    IntentDef("github-agent", "branch_create",
              "Create a new branch",
              ["create branch", "new branch", "git branch create", "make a branch",
               "branch off", "start a new branch"]),
    IntentDef("github-agent", "branch_delete",
              "Delete a branch",
              ["delete branch", "remove branch", "git branch delete", "drop branch"]),
    IntentDef("github-agent", "commit",
              "Commit changes to git",
              ["git commit", "commit changes", "save changes", "check in",
               "commit now", "submit changes"]),
    IntentDef("github-agent", "log",
              "Show commit history",
              ["git log", "show history", "commit history", "recent commits",
               "what happened", "show me the log"]),
    IntentDef("github-agent", "pull",
              "Pull from remote",
              ["git pull", "pull changes", "update from remote", "fetch updates"]),
    IntentDef("github-agent", "push",
              "Push to remote",
              ["git push", "push changes", "send to remote", "upload changes"]),
    IntentDef("github-agent", "worktree_add",
              "Add a git worktree",
              ["add worktree", "create worktree", "new worktree"]),
    IntentDef("github-agent", "worktree_list",
              "List git worktrees",
              ["list worktrees", "show worktrees", "worktree list"]),
    IntentDef("github-agent", "repo_discover",
              "Discover git repositories in paths",
              ["discover repos", "find repos", "scan for repos", "find git repos"]),
    IntentDef("github-agent", "repo_register",
              "Register a repository for tracking",
              ["register repo", "track repo", "add repo to tracking"]),
    IntentDef("github-agent", "repo_list",
              "List registered/tracked repositories",
              ["list repos", "show registered repos", "tracked repos"]),
    IntentDef("github-agent", "sync_now",
              "Trigger immediate git sync",
              ["sync now", "run sync", "sync repos", "force sync"]),
    IntentDef("github-agent", "gh_repo_info",
              "Get GitHub repository info",
              ["github repo info", "gh repo", "repo info", "github info"]),
    IntentDef("github-agent", "gh_pr_list",
              "List GitHub pull requests",
              ["github prs", "list prs", "pull requests", "show prs"]),
    IntentDef("github-agent", "gh_ci_status",
              "Get GitHub CI status",
              ["ci status", "github ci", "build status", "github actions"]),
    IntentDef("github-agent", "event",
              "Track cross-agent event",
              ["track event", "log event", "record agent work"]),
]
